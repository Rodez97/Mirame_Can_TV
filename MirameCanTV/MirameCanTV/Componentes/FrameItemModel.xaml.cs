...
namespace MirameCanTV.Componentes
{
    ...
    public partial class FrameItemModel : PancakeView
    {
        // Objeto Base
        ...
        /// </summa4ry>
        public static BindableProperty ParentBindingContextProperty = BindableProperty.Create(nameof(ParentBindingContext), typeof(object), typeof(FrameItemModel), null, propertyChanged: OnParentContextPropertyChanged);
        /// <summary>
        ...
        private static void OnParentContextPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            {
                (bindable as FrameItemModel).ParentBindingContext = newValue;
            }
        }
        #endregion
